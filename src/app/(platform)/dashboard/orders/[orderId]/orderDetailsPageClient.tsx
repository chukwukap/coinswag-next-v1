      ...
      <div className="flex justify-between mt-6">
        <div>
          ...
          <div className="rounded-[.5rem] border border-borderColor flex items-center  mt-4 gap-6 py-6 px-8 bg-secondary">
            ...
            />
            <div>
              <p className="text-neutral-600 text-sm mb-1">Payment Method</p>
              <p className="flex  items-center gap-2">
                {walletAddress ? (
                  ...
                  <Fragment>
                    <img src="/Icons/visa.svg" alt="" className="w-8 inline" />
                    <p>...6345</p>
                  </Fragment>
                )}
              </p>
            ...
            />
            <div>
              <p className="text-neutral-600 text-sm mb-1">Date Created</p>
              <p>Apr 12, 6:09AM</p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-10 w-[60%] min-w-[50rem]">
        ...
        <div className="grid grid-cols-3 gap-y-6">
          {billingInfo.map((info) => (
            <div>
              <p className="text-neutral-600 text-sm mb-1">{info.label}</p>
              <p>{info.value}</p>
            </div>
          ))}
        </div>
